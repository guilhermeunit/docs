...
<Note>
  ...
  o submit usa (`offer_ref.offer_id`), igual em produção. Se `offerId` vier
  `null` (re-consulta do mesmo CPF em menos de 60s reaproveita o grupo
  anterior), aguarde e re-consulte.
</Note>
