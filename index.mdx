...
| Bloco | Zipdin | Unit | C6 | Facta | Crefaz |
|---|:--:|:--:|:--:|:--:|:--:|
| `endereco` | obrigatório | obrigatório | obrigatório | obrigatório | obrigatório |
| `recebimento` | conta ou PIX | conta ou PIX¹ | só conta | conta ou PIX | só conta |
| `documento` (RG) | obrigatório | obrigatório | — | obrigatório | obrigatório |
...
| `vinculo` | obrigatório² | opcional | — | obrigatório (CNPJ + admissão + renda) | opcional |
| `titular.sexo` | obrigatório | opcional | — | obrigatório | obrigatório |
