...
| `44477700068` | Erro em todos os bancos |
| `55588811179` | Combo: mistura de desfechos por banco (cenário realista) |
| `66699922230` | Formalização Zipdin completa: submit → link de assinatura → aprovado |
| `77700033341` | Formalização Unit rejeitada pelo banco (prazo fora do limite) |
| `88811144452` | Formalização C6: proposta já em andamento (`duplicate`) |
| `99922255563` | Formalização Facta completa: submit → link → paga → cancelada (+ combo Unit/C6) |
| `10033366674` | Formalização Facta: oferta expirada no submit (`offer_expired`) |
